...
async def checkticket(ctx, amount: float, unread_only: bool = True):
    ...
    allowed_role_ids = [1103522760073945168, 1325902622120738866, 1361045953296990490, 1332736087029710958, 1361231253596278794, 1319913613389074487, 1267783758757757045, 1330907621984833536, 1338483485782048778]
